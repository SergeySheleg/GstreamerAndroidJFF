...
static JNIEnv* get_jni_env() {
    auto *env = static_cast<JNIEnv *>(pthread_getspecific(current_jni_env));
    if (env == nullptr) {
...
static void* app_function(void *userdata) {
    ...
    auto *data = static_cast<CustomData *>(userdata);
...
Java_org_untitled_sergey_untitled2_MainActivity_nativeInit(JNIEnv* env, jobject thiz) {
...
extern "C" JNIEXPORT void JNICALL
Java_org_untitled_sergey_untitled2_MainActivity_nativeFinalize(JNIEnv* env, jobject thiz) {
...
extern "C" JNIEXPORT void JNICALL
Java_org_untitled_sergey_untitled2_MainActivity_nativePlay(JNIEnv* env, jobject thiz) {
    CustomData *data = GET_CUSTOM_DATA (env, thiz, custom_data_field_id);
    if (data == nullptr) {
        return;
    }
...
extern "C" JNIEXPORT void JNICALL
Java_org_untitled_sergey_untitled2_MainActivity_nativePause(JNIEnv* env, jobject thiz) {
    CustomData *data = GET_CUSTOM_DATA (env, thiz, custom_data_field_id);
    if (data == nullptr) {
        return;
    }
...
Java_org_untitled_sergey_untitled2_MainActivity_nativeClassInit(JNIEnv* env, jclass klass) {
...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    auto res = vm->GetEnv(reinterpret_cast<void **>(&env), JNI_VERSION_1_4);
    if (res != JNI_OK) {
